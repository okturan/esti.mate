...
function updateTotals(e) {
  ...
  if (extraction.checked) {
    ...
    calculations.insertAdjacentHTML("beforeend", `<details><summary>Extraction: ﹩${roundToX(((extractionRate.value*profitMargin)+parseFloat(extractionRate.value)), 4)} ✕  ${wordCount.value} = ﹩${roundToX((extractionFee+extractionFee*profitMargin), 2)}</summary>
                                            <ul>
  ...
  if (cleanup.checked) {
    ...
    calculations.insertAdjacentHTML("beforeend", `<details><summary>Cleanup: ﹩${roundToX(((cleanupRate.value*profitMargin)+parseFloat(cleanupRate.value)), 4)} ✕  ${wordCount.value} = ﹩${roundToX((cleanupFee+cleanupFee*profitMargin), 2)}</summary>
                                            <ul>
  ...
  if (translation.checked) {
    ...
    calculations.insertAdjacentHTML("beforeend", `<details><summary>Translation: ﹩${roundToX(((translationRate.value*profitMargin)+parseFloat(translationRate.value)), 4)} ✕  ${wordCount.value} = ﹩${roundToX((translationFee+translationFee*profitMargin), 2)}</summary>
                                            <ul>
  ...
  if (editing.checked) {
    ...
    calculations.insertAdjacentHTML("beforeend", `<details><summary>Editing: ﹩${roundToX(((editingRate.value*profitMargin)+parseFloat(editingRate.value)), 4)} ✕  ${wordCount.value} = ﹩${roundToX((editingFee+editingFee*profitMargin), 2)}</summary>
                                            <ul>
  ...
  if (proofreading.checked) {
    ...
    calculations.insertAdjacentHTML("beforeend", `<details><summary>Proofreading: ﹩${roundToX(((proofreadingRate.value*profitMargin)+parseFloat(proofreadingRate.value)), 4)} ✕  ${wordCount.value} = ﹩${roundToX((proofreadingFee+proofreadingFee*profitMargin), 2)}</summary>
                                            <ul>
  ...
  if (transcription.checked) {
    ...
    calculations.insertAdjacentHTML("beforeend", `<details><summary>Transcription: ﹩${roundToX(((transcriptionRate.value*profitMargin)+parseFloat(transcriptionRate.value)), 4)} ✕  ${recordingLength.value} = ﹩${roundToX((transcriptionFee+transcriptionFee*profitMargin), 2)}</summary>
                                            <ul>
  ...
  if (contentCreation.checked) {
    ...
    calculations.insertAdjacentHTML("beforeend", `<details><summary>Content creation: ﹩${roundToX(((contentCreationRate.value*profitMargin)+parseFloat(contentCreationRate.value)), 4)} ✕  ${wordCount.value} = ﹩${roundToX((contentCreationFee+contentCreationFee*profitMargin), 2)}</summary>
                                            <ul>
  ...
  if (design.checked) {
    ...
    calculations.insertAdjacentHTML("beforeend", `<details><summary>Design: ﹩${roundToX(((designRate.value*profitMargin)+parseFloat(designRate.value)), 4)} ✕  ${designLength.value} = ﹩${roundToX((designFee+designFee*profitMargin), 2)}</summary>
                                            <ul>
  ...
  if (development.checked) {
    ...
    calculations.insertAdjacentHTML("beforeend", `<details><summary>Development: ﹩${roundToX(((developmentRate.value*profitMargin)+parseFloat(developmentRate.value)), 4)} ✕  ${developmentLength.value} = ﹩${roundToX((developmentFee+developmentFee*profitMargin), 2)}</summary>
                              <ul>
  ...
  if (voiceover.checked) {
    ...
    calculations.insertAdjacentHTML("beforeend", `<details><summary>Voiceover: ﹩${roundToX(((voiceoverRate.value*profitMargin)+parseFloat(voiceoverRate.value)), 4)} ✕  ${wordCount.value} = ﹩${roundToX((voiceoverFee+voiceoverFee*profitMargin), 2)}</summary>
                                            <ul>
  ...
  if (meeting.checked) {
    ...
    calculations.insertAdjacentHTML("beforeend", `<details><summary>Meeting: ﹩${roundToX(((meetingRate.value*profitMargin)+parseFloat(meetingRate.value)), 4)} ✕  ${meetingLength.value} = ﹩${roundToX((meetingFee+meetingFee*profitMargin), 2)}</summary>
                              <ul>
